...
pacman --noconfirm --needed -Syy networkmanager ripgrep sudo git base-devel wget curl xorg xorg-xinit bspwm sxhkd xwallpaper picom Alacritty vim emacs pulseaudio
