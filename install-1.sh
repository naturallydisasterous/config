...
pacman --noconfirm -Syy networkmanager ripgrep sudo git base-devel wget curl xorg xorg-xinit xwallpaper dmenu picom alacritty vim alsa alsa-utils neofetch
